...
app = Flask(__name__)
app.secret_key = 'session5'  # Required to use session
...
allowed_emails = ['vanilkum@redhat.com', 'anilkumarvishnu19@gmail.com', 'admin@app.com']
...
def trigger_by_account():
    ...
    command = [venv_python, 'new_main.py', account_ids_str, user_email]
